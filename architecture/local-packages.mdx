...
<CardGroup cols={2}>
  <Card title="Package Building" icon="arrow-right" href="/architecture/package-building">
    Learn how SRPMs are built into RPMs with dependency resolution
  </Card>
  <Card title="Initial Preparation" icon="arrow-left" href="/architecture/initial-prep">
