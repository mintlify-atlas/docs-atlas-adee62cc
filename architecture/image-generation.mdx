...
<Info>
For complete configuration file format documentation, see [Image Configuration](/image-config/overview).
</Info>
...
<CardGroup cols={2}>
  <Card title="Build Logs" icon="arrow-right" href="/architecture/logs">
    Learn how to interpret and troubleshoot build errors
  </Card>
  <Card title="Package Building" icon="arrow-left" href="/architecture/package-building">
