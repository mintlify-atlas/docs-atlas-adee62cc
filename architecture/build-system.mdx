...
<CardGroup cols={2}>
  <Card title="Initial Preparation" icon="gear" href="/architecture/initial-prep">
    Makefiles, Go tooling, toolchain, and chroot environments
  </Card>
  <Card title="Local Packages" icon="file-code" href="/architecture/local-packages">
    SPEC files, source management, and SRPM creation
  </Card>
  <Card title="Package Building" icon="hammer" href="/architecture/package-building">
    Dependency graphing, fetching, and parallel building
  </Card>
  <Card title="Image Generation" icon="hard-drive" href="/architecture/image-generation">
    Image composition, package installation, and format conversion
  </Card>
  <Card title="Build Logs" icon="file-lines" href="/architecture/logs">
...
<Card title="Initial Preparation Phase" icon="arrow-right" href="/architecture/initial-prep">
