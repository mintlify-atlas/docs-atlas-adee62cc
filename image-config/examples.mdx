...
<CardGroup cols={2}>
  <Card title="Build Images" href="/building/image-stage" icon="hammer">
    Learn how to build images from configurations
  </Card>
  <Card title="Image Customizer" href="/toolkit/imagecustomizer" icon="wand-magic-sparkles">
    Customize existing images
  </Card>
  <Card title="Disks and Partitions" href="/image-config/disks-partitions" icon="hard-drive">
