...
<CardGroup cols={2}>
  <Card title="Disk Configuration" href="/image-config/disks-partitions" icon="hard-drive">
...
- [Building Images](/building/image-stage)
- [Image Customizer](/toolkit/imagecustomizer)
