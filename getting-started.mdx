...
- **Azure Linux**: See [Azure Linux prerequisites](/building/prerequisites-mariner)
- **Ubuntu**: See [Ubuntu prerequisites](/building/prerequisites-ubuntu)
...
<CardGroup cols={2}>
  ...
  <Card title="Customize your image" icon="palette" href="/building/customization">
    Add packages and customize your Azure Linux image
  </Card>
  <Card title="Security features" icon="shield-check" href="/security/features">
    Understand the built-in security capabilities
  </Card>
  <Card title="How it works" icon="wrench" href="/how-it-works/introduction">
